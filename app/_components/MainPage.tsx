  ...
  const startFirstVisitOnboarding = () => {
    startOnboarding(
      [
        ...
        //   focus: "poem",
        //   message: `
        //             <div>This haiku poem was created with the assistance of ChatGPT, and the art was specifically generated by DALL-E to blend with the poem.</div>
        ...
        // Poem and Poem Actions
        {
          // focus: "poem-and-poem-actions",
          focus: "poem",
          message: `
            <div style="display: flex; flex-direction: column; gap: 0.4rem; padding: 0.8rem;">
              <div>This haiku poem was created with the assistance of ChatGPT, and the art was specifically generated by DALL-E to blend with the poem.</div>
