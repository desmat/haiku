  ...
  return (
    <Suspense
      fallback={
        <Link
          href="/"
          className={` _bg-pink-200 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full p-2 opacity-50 cursor-pointer z-50 md:text-[26pt] sm:text-[22pt] text-[16pt]`}
