...
export default function AdjustLayoutControls({
  ...
  return (
    <div className="adjust-layout-controls">
      <div
        className="bg-blue-400 w-[40vw] h-40 left-[50%] translate-x-[-50%] top-[50%] translate-y-[-50%] fixed cursor-move z-20"
        onClick={(e: any) => {
      ...
      />
      <div
        className="bg-pink-200 w-[40vw] h-10 left-[50%] translate-x-[-50%] -top-10 absolute cursor-n-resize z-30"
        onClick={(e: any) => {
          adjustLayoutClamped({
      ...
      />
      <div
        className="bg-pink-400 w-[40vw] h-10 left-[50%] translate-x-[-50%] -top-20 absolute cursor-n-resize z-30"
        onClick={(e: any) => {
          adjustLayoutClamped({
      ...
      />
      <div
        className="bg-pink-200 w-[40vw] h-10 left-[50%] translate-x-[-50%] -bottom-10 absolute cursor-s-resize z-30"
        onClick={(e: any) => {
          adjustLayoutClamped({
            top: poemLayout?.top ? poemLayout.top + 5 : undefined,
            bottom: poemLayout?.bottom ? poemLayout.bottom - 5 : undefined,
      ...
      />
      <div
        className="bg-pink-400 w-[40vw] h-10 left-[50%] translate-x-[-50%] -bottom-20 absolute cursor-s-resize z-30"
        onClick={(e: any) => {
          adjustLayoutClamped({
            top: poemLayout?.top ? poemLayout.top + 15 : undefined,
            bottom: poemLayout?.bottom ? poemLayout.bottom - 15 : undefined,
      ...
      />
      <div
        className="bg-blue-200 w-[40vw] h-[3rem] left-[50%] translate-x-[-50%] top-0 fixed cursor-move z-30"
        onClick={(e: any) => {
          adjustLayoutClamped({
      ...
      />
      <div
        className="bg-blue-200 w-[40vw] h-[3rem] left-[50%] translate-x-[-50%] bottom-0 fixed cursor-move z-30"
        onClick={(e: any) => {
          adjustLayoutClamped({
