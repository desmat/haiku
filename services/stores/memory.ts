...
import { DailyHaiku, Haiku, LikedHaiku, UserHaiku } from "@/types/Haiku";
...
export function create(): Store {
  return {
    ...
    haikuAlbums: new MemoryStore<HaikuAlbum>("haikualbum"),
    ...
    likedHaikus: new MemoryStore<LikedHaiku>("test1likedhaiku"),
